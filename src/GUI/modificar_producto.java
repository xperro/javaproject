          ...
          if(producto.getTipo().equals("PERROS")){
           ...
           if(producto.getTipo().equals("AVES Y OTROS")){
            ...
            if(producto.getTipo().equals("CONFITERIA")){
              ...
              if(producto.getTipo().equals("OTROS")){
...
//        jTable1.getColumn("NIVEL").setPreferredWidth(1);
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Falta Medida", "Mg", "Gr", "Kg", "Ton", "Lata", "Unidad", "Sachet", "Lt", "Cc" }));
