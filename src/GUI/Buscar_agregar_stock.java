...
public class Buscar_agregar_stock extends javax.swing.JDialog implements KeyListener, ActionListener, MouseListener {
    ...
    public Buscar_agregar_stock(java.awt.Frame parent, boolean modal) throws SQLException {
        initComponents(); 
        iniciar();
    }

    Buscar_agregar_stock(int usuario) throws SQLException {
        initComponents();
    ...
    Buscar_agregar_stock(jframeUsuario aThis, boolean b, int u) throws SQLException {
        //super(aThis, b);
        initComponents();
        this.usuario = u;
        iniciar();
...
ArrayList<Productos> aux2 = new ArrayList<Productos>();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            ...
            try {
                ...
                Logger.getLogger(Buscar_agregar_stock.class.getName()).log(Level.SEVERE, null, ex);
            }
                    Object[] object = new Object[10];
                    int k=0;
                    while(aux2.size()>k){
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        op.setMarca(modelo.getValueAt(i, 3).toString());
         ...
         op.setCodigo_barra(modelo.getValueAt(i, 9).toString());
            ...
            agregarr_stock a = null;
            try {
                a = new agregarr_stock(op.getId_producto());
            } catch (SQLException ex) {
                Logger.getLogger(Buscar_agregar_stock.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Buscar_agregar_stock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                Buscar_agregar_stock dialog = null;
                try {
                    dialog = new Buscar_agregar_stock(new javax.swing.JFrame(), true);
                } catch (SQLException ex) {
                    Logger.getLogger(Buscar_agregar_stock.class.getName()).log(Level.SEVERE, null, ex);
                }
